/*
 ...
 starts in current directory and recursively climbs up to
 root of filesystem.  prints top part then prints current
 part
...
/*
 looks through current directory for a file with this inode number and
