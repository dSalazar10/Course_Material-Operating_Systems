...
/* Spawn a child process running a new program.
    ...
    strings to be passed as the programâ€™s argument
    list. Returns the process ID of the spawned process. */
...
char* arg_list[] = { "ls", /* argv[0], the name of the program. */ "-l", "/", NULL };
